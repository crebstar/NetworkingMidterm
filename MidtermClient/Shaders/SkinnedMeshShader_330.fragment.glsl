...
void main()
{
	...
	vec3 normalizedBitangent = normalize( v_bitangent );

	// Normals
	mat3 tangentToWorldSpace = mat3( normalizedTangent, normalizedBitangent, normalizedNormal );
	...
	//vec3 normalTexelDebug = vec3( v_normal.x, v_normal.y, v_normal.z );
	//normalTexelDebug.x = (normalTexelDebug.x * 2.0) - 1.0;
	//normalTexelDebug.y = (normalTexelDebug.y * 2.0) - 1.0;
	//normalTexelDebug.z = (normalTexelDebug.z * 2.0) - 1.0;
